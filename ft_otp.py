...
def encrypt_and_store_key(hex_key):
    ...
    encoded_key = base64.urlsafe_b64encode(hex_key_bytes)   # Base64 encode the key
...
def decrypt_key(file_path):
    ...
    hex_key_bytes = base64.urlsafe_b64decode(encoded_key)   # Decode the base64-encoded key
